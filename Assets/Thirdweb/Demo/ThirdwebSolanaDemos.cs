...
public class ThirdwebSolanaDemos : MonoBehaviour
{
    ...
    void Start()
    {
        sdk = new ThirdwebSDK("solana-devnet");
        InitializeState();
    }
    ...
    public async void PhantomLogin()
    {
    ...
    {
        // fetch single NFT
        var program = sdk.GetProgram("5stEUeGmauGCBvxnjav2pEjPQ7rBCUpmTH8DXpNW6Gxs", "nft-collection");
        var nfts = await program.Call<List<NFT>>("getAll");
        resultText.text = "Fetched " + nfts.Count + " NFTs";
    }
